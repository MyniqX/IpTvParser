	...
	internal class Profile : INotifyPropertyChanged
	{
		...
		public int GroupCount
		{
			...
			set
			{
				if (value != _groupCount)
					PropertyChanged?.Invoke(this, new PropertyChangedEventArgs(nameof(GroupCount)));
				_groupCount = value;
			}
		}
		...
		public int TvShowSeasonCount
		{
			set
			{
				...
				PropertyChanged?.Invoke(this, new PropertyChangedEventArgs(nameof(TvShowSeasonCount)));
			}
		...
		public int TvShowEpisodeCount
		{
			set
			{
				...
				PropertyChanged?.Invoke(this, new PropertyChangedEventArgs(nameof(TvShowEpisodeCount)));
			}
		...
		public int LiveStreamCount
		{
			set
			{
				...
				PropertyChanged?.Invoke(this, new PropertyChangedEventArgs(nameof(LiveStreamCount)));
			}
		...
		public int MovieCount
		{
			...
			{
				_movieCount = value;
				PropertyChanged?.Invoke(this, new PropertyChangedEventArgs(nameof(MovieCount)));
			}
			get => _movieCount;
		}
		...
		public int TvShowCount
		{
			...
			{
				_tvShowCount = value;
				PropertyChanged?.Invoke(this, new PropertyChangedEventArgs(nameof(TvShowCount)));
			}
			get => _tvShowCount;
		}
		...
		private async Task<bool> LoadM3UFromFileAsync()
		{
			...
			var parser = new M3UFileParser(fi);
